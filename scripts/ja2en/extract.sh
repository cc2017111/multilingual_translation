...
FILE_ROOT=${PROJECT_ROOT}/experiments/example/data/toy/models/fine-tune/transformer_big/en2zh/results/checkpoint_re
...
FILE=${FILE_ROOT}/ja2en__wmt14_head100.txt
echo $FILE
...
grep ^S ${FILE} | cut -f2- > ${FILE_ROOT}/result/answer.bpe.en
...
sacrebleu ${FILE_ROOT}/result/predict.zh -i ${FILE_ROOT}/result/answer.zh -m bleu -b -w 1

...
echo ${language1_config_file} ${language1_file}
source ${repo_dir}/tools/data_preprocess/prep_each.sh ${language1_config_file} ${language1_file} ${output_path} ${default_langs_tokenizer1} >&2 &
source ${repo_dir}/tools/data_preprocess/prep_each.sh ${language2_config_file} ${language2_file} ${output_path} ${default_langs_tokenizer2} >&2
wait
